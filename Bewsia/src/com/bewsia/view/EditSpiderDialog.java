...
public class EditSpiderDialog extends Dialog {

    private Logger logger = Logger.getLogger(EditSpiderDialog.class);
    ...
    public EditSpiderDialog(Shell parent, Controller controller, Spider spider) {
        super(parent, SWT.DIALOG_TRIM | SWT.APPLICATION_MODAL);
        this.controller = controller;
        this.spider = spider;
        setText(Labels.get("EditSpiderDialog.WindowTitle"));
    }
    ...
    private void createContents(final Shell shell) {
        ...
        label.setText(Labels.get("EditSpiderDialog.LabelTitle"));
        fd = new FormData();
        ...
        text.setText(spider.getTitle());

        label = new Label(shell, SWT.NONE);
        label.setText(Labels.get("EditSpiderDialog.LabelScript"));
        fd = new FormData();
        ...
        fd.height = 300;
        text.setLayoutData(fd);
        text.setText(spider.getScript());

        label = new Label(shell, SWT.NONE);
        label.setText(Labels.get("EditSpiderDialog.LabelBuiltinScript"));
        fd = new FormData();
        ...
        button = new Button(shell, SWT.PUSH);
        button.setText(Labels.get("EditSpiderDialog.ButtonSave"));
        fd = new FormData();
        fd.bottom = new FormAttachment(100, -10);
        ...
        button.addSelectionListener(new SelectionListener() {
			...
			@Override
			public void widgetSelected(SelectionEvent arg0) {
				spider.setTitle(textTitle.getText());
				spider.setScript(textScript.getText());
				spider.save();
				canceled = false;
				shell.close();
			}
