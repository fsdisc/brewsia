...
public class Files {
	...
	private static void setup() {
		...
		registry.put("Home", "Home.txt");
		registry.put("Result", "Result.txt");
		registry.put("ResultItem", "ResultItem.txt");
		registry.put("ResultPageList", "ResultPageList.txt");
		registry.put("ResultPageItem", "ResultPageItem.txt");
	}
	...
	public static byte[] getB(String key) {
		setup();
		String filename = "/com/bewsia/resource/files/" + registry.get(key);
		byte[] tag = new byte[0];
